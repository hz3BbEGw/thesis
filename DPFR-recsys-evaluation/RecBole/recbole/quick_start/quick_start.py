...
def run_recbole(
    ...
    with open(f"train_val_test/{dataset_name}_train.pickle","wb") as f:
        pickle.dump(train_data.dataset.inter_feat.interaction, f, pickle.HIGHEST_PROTOCOL)
    
    with open(f"train_val_test/{dataset_name}_valid.pickle","wb") as f:
        pickle.dump(valid_data.dataset.inter_feat.interaction, f, pickle.HIGHEST_PROTOCOL)

    with open(f"train_val_test/{dataset_name}_test.pickle","wb") as f:
        pickle.dump(test_data.dataset.inter_feat.interaction, f, pickle.HIGHEST_PROTOCOL)
