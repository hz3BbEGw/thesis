...
import pickle #for saving recommendation list and relevance
...
class Trainer(AbstractTrainer):
    ...
    def evaluate(
        ...
        if load_best_model:
            print("Saving recommendation list and relevance...")
            dataset_name = self.config.dataset
            _, model_version = os.path.split(checkpoint_file)

            with open(f"struct/struct_{model_version}", "wb") as f:
